...
Route::get('/inroll-now/{id}', [WebController::class, "inroll"])->name("inroll-now");
...
Route::middleware(['student'])->group(function () {
    ...
    Route::post('/updete-student-profile/{id}', [StudentDashboardController::class, "updeteProfile"])->name("updete-student-profile");
...
Route::middleware(["teacher",])->post('/updete-subject/{id}', [SubjectController::class, "updete"])->name("updete-subject");
...
Route::middleware(["teacher",])->get('/enroll-student/{id}', [SubjectController::class, "enrollStudent"])->name("enroll-student");
...
Route::middleware(["auth:sanctum", "verified", 'superAdmin'])->post("/updete-user/{id}", [UserController::class,"updete"])->name("updete-user");
...
Route::middleware(["auth:sanctum", "verified",])->get("/student-status/{id}", [AdminStudentController::class,"studentStatus"])->name("student-status");
Route::middleware(["auth:sanctum", "verified",])->get("/update-enroll-status/{id}", [AdminStudentController::class,"updeteEnrollStatus"])->name("update-enroll-status");
