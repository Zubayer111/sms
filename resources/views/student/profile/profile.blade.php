                ...
                <div class="col-md-3">
                    <div class="card">
                        <div class="list-group list-group-flush">
                            <a href="{{route("student-dashboard")}}" class="list-group-item">My All Course</a>
                ...
                <div class="col-md-9">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route("updete-student-profile", ["id" => $student->id])}}" method="POST" enctype="multipart/form-data">
                                @csrf
                            <div class="row mb-3">
