...
class WebController extends Controller
{
    ...
    public function inroll($id)
    {
        if(Session::get("student_id"))
        {
            ...
            return redirect("/student-dashboard")->with("message", "New course enroll successfully");
        }
        else
        {
    ...
    public function newEnroll(Request $request, $id)
    {
        ...
        if($this->student)
        {
            ...
            if($this->enroll)
            {
                return redirect("/course-detail/" . $id)->with("message", "You alradey enroll this course. Please try another one.");
            }
        }
